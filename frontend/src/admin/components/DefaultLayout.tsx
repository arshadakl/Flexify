  ...
  return (
    <>
     <nav className="fixed top-0 z-50 w-full bg-slate-100 border-gray-300 border-b-[1px]   dark:bg-gray-800 dark:border-gray-700">
      ...
      <aside
        id="logo-sidebar"
        className="fixed top-0 left-0 z-40  h-screen  transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
        aria-label="Sidebar"
      >
        <Sidebar />
      </aside>
