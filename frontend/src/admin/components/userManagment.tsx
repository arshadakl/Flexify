...
import { blockUser, getAllusers } from "../../common/utils/APIs/AdminApi";
  ...
  return (
    <>
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        {/* <h2 className="text-4xl m-5">User Management</h2> */}
      <h1 className="text-2xl font-sans font-semibold py-5">User Management </h1>
