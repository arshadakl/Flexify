        ...
        <section className=" min-h-80  ">
          ...
          <div className="md:w-2/6 mx-auto lx:w-full">
            ...
            <div className="flex justify-end">
              {userType !== "" ? 
            <button  type="button" onClick={()=>pageManage(2)} className="my-5 item-position-end focus:outline-none text-white bg-logo-green hover:bg-green-600  focus:ring-logo-green font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-logo-green dark:hover:bg-logo-green">Next</button>
            : null }
            </div>
          </div>
