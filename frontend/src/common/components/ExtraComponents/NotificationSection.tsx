    ...
    <>
      <button
        ...
        className={`relative inline-flex items-center text-sm font-medium text-center  ${
          bg == "none" ? "md:text-white text-logo-green md:mx-0 mx-2" : "text-logo-green"
        } hover:text-logo-green  focus:outline-none dark:hover:text-white dark:text-gray-400`}
        type="button"
      >
        <svg
          className="w-5 h-5"
        ...
        </svg><p className="mx-2 text-lg text-gray-800 md:hidden block">Notification</p>
      ...
      >
        ...
        <div className="divide-y divide-gray-100 dark:divide-gray-700">
          {notification?.map((notif) => {
            return (
              <a className="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
