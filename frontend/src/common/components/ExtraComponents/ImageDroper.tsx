      ...
      <div className="flex items-center justify-center w-full">
        ...
        >
          {(previewImage) ? (<>
            ...
            <img ref={imageRef} src={croppedImage ? croppedImage : previewImage} alt="Preview" className="w-full h-full object-cover" />
        ...
        <div className="fixed inset-0  flex items-center justify-center bg-gray-900 bg-opacity-75 z-50">
          <div className="bg-white p-4 rounded-lg w-3/6">
            <div className="relative">
              <img ref={imageRef} src={previewImage || ''} alt="Cropping Preview" style={{maxHeight:"80vh"}} className="w-full h-full object-cover" />
              <button
                className="absolute top-2 right-2 bg-red-700 text-white px-2 py-1 rounded-md hover:bg-red-800"
