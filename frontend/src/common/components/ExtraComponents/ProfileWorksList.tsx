    ...
    <>
      ...
      <div className="w-full flex  min-h-full  flex-wrap gap-5 ">
          ...
          return (
            ...
            >
              ...
              <p className="my-1 pl-4 text-sm font-bold text-gray-500">
                {ShortenDescription(work.title, 25)}
              </p>
              ...
              {work.tags[0]
                ...
                .map((tag) => {
                  return (
                    <span className="bg-gray-100 mb-5 mx-2 text-gray-800 text-sm font-medium me-2 px-1.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">
                      {tag}
                    </span>
                  );
                })}
              ...
              <button
                data-modal-target={work?._id}
                data-modal-toggle={work?._id}
                className="fa-solid fa-trash-can absolute  right-1  top-1 text-gray-900 hover:text-gray-500 hover:bg-slate-50 bg-white p-2 text-[12px] rounded-[50%] shadow"
              />
                  ...
                  <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="p-4 md:p-5 text-center">
                      ...
                      <button
                        data-modal-hide={work?._id}
                        type="button"
                        onClick={() => handdileDelete(work?._id)}
        ...
        >
          <div className="m-auto text-xl text-center">
            <i className="fa-solid text-5xl fa-circle-plus " />
            <p className="text-[11px]  font-semibold">Create a new Work Post</p>
          </div>
        </motion.div>
      </div>
    </>
