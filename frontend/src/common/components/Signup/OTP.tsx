        ...
        <form ref={formRef} id="otp-form" onSubmit={handleSubmit}>
          ...
          <div className="max-w-[260px] mx-auto mt-4">
            {isActive ? (
              ...
              <button className="w-full cursor-not-allowed  hover:bg-gray-600 inline-flex justify-center whitespace-nowrap rounded-lg bg-gray-600 px-3.5 py-2.5 text-sm font-medium text-white shadow-sm shadow-indigo-950/10 hover:logo-green focus:outline-none focus:ring focus:ring-indigo-300 focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300 transition-colors duration-150">
                Verify Account
              </button>
            )}
          </div>
