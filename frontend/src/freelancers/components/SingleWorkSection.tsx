    ...
    <>
      <div className="block w-full mx-auto p-6 bg-white font-poppins rounded  dark:border-gray-700 dark:hover:bg-gray-700">
        <div className="flex flex-col gap-5">
          ...
          <hr />
          <p
            onClick={() => navigate(`/freelancer/${selectedWork.user._id}`)}
          ...
          >
            ...
            <motion.span
              ...
              className="ml-2  m-auto text-md"
            >
              {selectedWork.user.username}
            </motion.span>
          </p>
            ...
            <div className="w-full">
              <div className="relative   ">
                ...
                <input
                  readOnly
                  name="deliveryPeriod"
                  value={`Efficient Completion Within   ${
                    selectedWork?.deliveryPeriod as number
                  } Business Days`}
                  disabled
          ...
          <div className="flex">
            <div className="mb-3">
              ...
              <div className="relative w-full">
                ...
                {selectedWork?.referenceMaterial ? (
                  <span className="bg-gray-100 text-gray-800 text-md font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">
                    Reference Materials
                  </span>
                ) : null}
      ...
      <SellerDetails
        seller={selectedWork?.user}
        details={selectedWork?.freelancerdetails}
      />
    </>
  );
}
