...
const PostCards = ({ handdileDelete, posts, tab }: {handdileDelete:any; posts: IWork[]; tab: string }) => {
                ...
                <div className="flex flex-col justify-end my-auto">
                  ...
                  <div className="flex justify-between items-end">
                    ...
                    <div className="flex gap-1">
                     <button onClick={()=>navigate(`/edit-post?id=${post._id}`)} className="px-3 py-2 bg-gray-800 text-white text-xs font-bold uppercase rounded">
                      Edit Work
                    </button>
                     <button 
                  ...
                  <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="p-4 md:p-5 text-center">
                      ...
                      <button
                        data-modal-hide={post?._id}
                        type="button"
                        onClick={() => handdileDelete(post?._id)}
