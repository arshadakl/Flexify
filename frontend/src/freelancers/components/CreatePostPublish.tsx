  ...
  return (
    <>
      ...
      <div className="w-full  bg-slate-50 min-h-[80vh] py-5">
        <div className="block lg:w-3/5 w-6/6 mx-3 lg:mx-auto p-6 bg-white border border-gray-200 rounded   dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
